MANIFEST_DESC = {
    'accessibility_service': {
        ...
        'level': 'high',
        'description': ('Accessibility services can see everything '
                        'displayed on the screen and perform '
                        'actions on behalf of the user. '
                        'Malicious applications can exploit this to '
                        'steal user data, impersonate apps, '
                        'or perform other malicious actions. '
                        'Combined with Device Admin privileges, '
                        'malware can effectively take control '
                        'of the device.'),
    ...
    'pixpirate': {
        ...
        'level': 'high',
        'description': ('If the main activity is not '
                        'declared with "android.intent.action.MAIN" '
                        'and "android.intent.category.LAUNCHER" in '
                        'the manifest, no app icon appears on the '
                        'home screen, making the app completely '
    ...
    'bind_device_admin': {
        ...
        'description': ('Device admin privileges allow an app '
                        ...
                        'app uninstall or to create ransomware.'),
